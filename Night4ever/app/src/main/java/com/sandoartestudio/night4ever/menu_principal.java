...
public class menu_principal extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_minhaConta) {
            ...
            Intent intentMinhaConta = new Intent(menu_principal.this, minhaConta.class);

            startActivity(intentMinhaConta);

        } else if (id == R.id.nav_album_fragment) {

            Intent intentAlbum = new Intent(menu_principal.this, album.class);
